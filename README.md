...
**II. [체크포인트](#체크포인트)**    
 - [아키텍처 설계(IaaS) (15점)](#아키텍처 설계(IaaS) (15점))
 - [Data Modeling/서비스 분리/설계 역량(BIZ) (15점)](#Data Modeling/서비스 분리/설계 역량(BIZ) (15점))
 - [MSA개발 또는 개발관리 역량 (20점)](#MSA개발 또는 개발관리 역량 (20점))
 - [클라우드 배포 역량 (20점)](#클라우드 배포 역량 (20점))

**III. [분석/설계](#분석설계)**    
 - 아키텍처 설계(#아키텍처 설계)
 - MSAEZ 모델링(Event Storming 결과)(#MSAEZ 모델링(Event Storming 결과))
 - OOOOO 아키텍처 다이어그램 도출(#OOOOO 아키텍처 다이어그램 도출)
